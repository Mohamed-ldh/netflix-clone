...
<head>
    ...
    <title>Horror Movies - IL TEATRO</title>
...
<body>
    <header>
        <div class="fade_bottom">
            <img src="Assets/the conjuring_logo2.jpg" alt="" id="background" >
            <div class="text">
                <div class="fade">
            ...
            <label for="" class="op" style="position: fixed;"><h1>Horror Movies</h1></label>
        </header>
            
            <img src="Assets/the conjuring.jpg" alt="" id="pb_logo"><br>
            <label for="" id="disc">After moving into Rhode Island, a family experiences supernatural occurences <br> and seeks help from a pair of noted paranormal investigators.</label>
        <div class="button">
        ...
        <label for="" id="popu"><h2>The Most Spine Chilling Movies</h2></label>
        <div class="container">
          <div class="swiper-container">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img src="Assets/purge.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/alive.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/blacks.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/friday.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/quiet.jpg" alt="">
              </div>
              
              <div class="swiper-slide">
                <img src="Assets/exorcism.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/zodiac.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/grudge.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/conjuring2.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/eli.jpg" alt="">
              </div>
              <div class="swiper-slide">
                  <img src="Assets\freddy.jpg" alt="">
                </div>
            </div>
