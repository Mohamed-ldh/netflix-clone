...
<body>
    <header>
        <div class="fade_bottom">
            <img src="Assets\extraction_bd.jpg" alt="" id="background" >
            <div class="text">
                <div class="fade">
            ...
            <label for="" id="title" style="position: fixed;">Movies</label>
                ...
                <div class="dropdown-menu information-grid">
                  <div>
                    <div class="dropdown-links">
                      <a href="#" class="link" onclick="movie_action()">Action</a>
                    </div>
                  </div>
                  <div>
                    <div class="dropdown-links">
                      <a href="#" class="link" onclick="movie_sport()">Sports</a>
                    </div>
                  </div>
                  <div>
                    <div class="dropdown-links">
                      <a href="#" class="link" onclick="movie_horror()">Horror</a>
                    </div>
                  </div>
                </div>
        </header>
            
            <img src="Assets/extraction_logo.png" alt="" id="pb_logo"><br>
            <label for="" id="disc">A hardened mercenary's mission becomes a soul-searching race to race to survive<br>when he's sent into Bangladesh to rescue a drug lord's kidnapped son.</label>
        <div class="button">
            <a href="video.php" class="btn btn-info btn-lg" onclick="video()">
        ...
        <label for="" id="popu"><h2>Movies Based On Book | Real Life</h2></label>
        <div class="container">
          <div class="swiper-container">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img src="Assets/troy.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/8miles.jpg" alt="">
              </div>
              ...
              <div class="swiper-slide">
                <img src="Assets/bad_boys_list.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/fast9.jpg" alt="">
              </div>
              <div class="swiper-slide">
                  <img src="Assets/chainsaw.jpg" alt="">
                </div>
            </div>
