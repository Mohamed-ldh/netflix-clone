...
<body>
    <header>
        <div class="fade_bottom">
            <img src="Assets/PeakyBlinders.jpg" alt="" id="background" >
            <div class="text">
                <div class="fade">
                <a href=""><img src="Assets/Logo-removebg-preview (2).png" alt="" id="logo"></a>
                <div class="tabs">
            ...
            <img src="Assets/PB Logo.png" alt="" id="pb_logo"><br>
