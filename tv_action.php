...
<head>
    ...
    <title>Action TV Shows - IL TEATRO</title>
...
<body>
    <header>
        <div class="fade_bottom">
            <img src="Assets/Vikings_wall.jpg" alt="" id="background" >
            <div class="text">
                <div class="fade">
            ...
            <label for="" class="op" style="position: fixed; left:180px"><h1>Action TV Shows</h1></label>
        </header>
            
            <img src="Assets/vikings_logo.png" alt="" id="pb_logo"><br>
        ...
        <div class="container">
          <div class="swiper-container">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img src="Assets/skyrojo.jpg" alt="">
              </div>
              <div class="swiper-slide">
