...
<head>
    ...
    <title>Crime TV Shows - IL TEATRO</title>
...
<body>
    <header>
        <div class="fade_bottom">
            <img src="Assets/topboy_wall.jpg" alt="" id="background" >
            <div class="text">
                <div class="fade">
            ...
            <label for="" class="op" style="position: fixed; left:180px"><h1>Crime TV Shows</h1></label>
        </header>
            
            <img src="Assets/topboy.jpg" alt="" id="pb_logo"><br>
        ...
        <div class="container">
          <div class="swiper-container">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img src="Assets/2pac.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/dahmer.jpg" alt="">
              </div>
              <div class="swiper-slide">
              ...
              <div class="swiper-slide">
                <img src="Assets/gang.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/blacklist.jpg" alt="">
              </div>
              <div class="swiper-slide">
                <img src="Assets/body.jpg" alt="">
              </div>
              <div class="swiper-slide">
